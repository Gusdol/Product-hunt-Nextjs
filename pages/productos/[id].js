...
const Producto = () => {
    ...
    const votarProducto = () => {
        ...
        guardarconsultarDB(true); // hay un comentario entonces consultar a la BD
    }
    ...
    const agregarComentario = e => {
        ...
        // tomar copia de comentarios y agregarles al arreglo
    ...
    return (
        <Layout>
            ...
            { error ? <Error404 /> : (
                  ...
                  <ContenedorProducto>
                          <div>
                              <p>Publicado hace: { formatDistantetoNow( new Date(creado), {locale: es} )} </p>
